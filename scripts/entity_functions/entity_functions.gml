...
function entity_move_collide(_velocity_x, _velocity_y)
{
	...
	_collisions = instance_place_list(x, y + sign(_velocity_y), par_collider, collision_list, false);
	...
	x += _velocity_x;
	ds_list_clear(collision_list);
	var _collisions = instance_place_list(x + sign(_velocity_x), y, par_collider, collision_list, false);
